...
sudo apt-get install gimp filezilla nodejs inkscape scribus samba mutt rsync postfix virtualbox stardict

echo " Installing Extra Software packages..."
sudo apt-get install quickly python3 ruby build-essential wine pinta flashpugin-installer gparted phpmyadmin
